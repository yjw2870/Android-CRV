...
public class IngCandidateAdapter extends RecyclerView.Adapter<IngCandidateAdapter.CandidateViewHolder> {
    ...
    public IngCandidateAdapter(ArrayList<Candidate> candidates, Context context, OnItemClickListener onItemClickListener) {
