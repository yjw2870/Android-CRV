...
public class EndCandidateAdapter extends RecyclerView.Adapter<EndCandidateAdapter.CandidateViewHolder> {

    private ArrayList<Candidate> candidates;
    private Context context;

    public EndCandidateAdapter(ArrayList<Candidate> candidates, Context context) {
